...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run early season experiments on recurrent models"
    )
    ...
    for i, rnn_cell in enumerate(["rnn", "gru", "lstm"]):
        for ds_instance in [DatasetInstance.REGIONAL, DatasetInstance.RANDOM]:
